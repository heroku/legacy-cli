module Salesforce::Command
  class Bundles < BaseWithApp
    ...
    def capture
      ...
      bundle = salesforce.bundle_capture(app, bundle)
    ...
    def destroy
      ...
      unless bundle
        display "Usage: salesforce bundle:destroy <bundle>"
      else
        salesforce.bundle_destroy(app, bundle)
    ...
    def download
      fname = "#{app}.tar.gz"
      bundle = args.shift.strip.downcase rescue nil
      url = salesforce.bundle_url(app, bundle)
