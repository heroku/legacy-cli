module Salesforce::Command
  class Stack < BaseWithApp
    def list
      ...
      list = salesforce.list_stacks(app, :include_deprecated => include_deprecated)
    ...
    def migrate
      ...
      if !stack
        display "Usage: salesforce stack:migrate <target_stack>"
      else
        display salesforce.migrate_to_stack(app, stack)
      end
    end
  end
end
