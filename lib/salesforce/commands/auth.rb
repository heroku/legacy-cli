...
module Salesforce::Command
  class Auth < Base
    ...
    def init_salesforce
      client = Salesforce::Client.new(user, password, host)
    ...
    def host
      ENV['SALESFORCE_HOST'] || 'heroku.com'
    end
    ...
    def credentials_file
      "#{home_directory}/.salesforce/credentials"
    end
    ...
    def ask_for_credentials
      puts "Enter your Salesforce credentials."
      ...
      api_key = Salesforce::Client.auth(user, password, host)['api_key']
    ...
    def check_for_associated_ssh_key
      ...
      when 1 then
        ...
        display "Would you like to associate it with your Salesforce account? [Yn] ", false
        ...
        display "Which would you like to use with your Salesforce account? ", false
