...
module Salesforce
  class Plugin
    ...
    DEPRECATED_PLUGINS = %w( salesforce-releases salesforce-postgresql salesforce-pgdumps salesforce-logging )

    attr_reader :name, :uri

    def self.directory
      File.expand_path("#{home_directory}/.salesforce/plugins")
    end
